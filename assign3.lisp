...
(defun test-case ()
  ...
  (format t "set-union Test case (1 8 5 9 2 4): ~x~%" (set-union '(1 5 9 8) '(5 9 2 4)))
  ...
  (format t "set-diff Test 1 (1) : ~x~%" (set-diff '(1 2) '(2 4)))
  (format t "set-diff Test 2 (1 4): ~x~%" (set-diff '(1 2 3 4) '(2 3 5 6)))
